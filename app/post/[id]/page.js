...
export default function Post({params}){
    ...
    return (
        ...
        <div  className="text-center">
            <h3 className="text-xl">This is post page</h3>
            <h3 className="text-lg">{id}</h3>

            {/* {
                post.id = id ? <h1>hello</h1>: <h2>wrong</h2>
            } */}
              ...
              <div className="max-w-3xl px-4 pt-6 pb-12 mx-auto lg:pt-10 sm:px-6 lg:px-8">
                  <div className="max-w-2xl">
                      ...
                      <div className="flex items-center justify-between mb-6">
                        <div className="flex w-full sm:items-center gap-x-5 sm:gap-x-3">
                            <div className="flex-shrink-0">
                                <Image width={100} height={100} className="w-12 h-12 rounded-full" src="https://media.istockphoto.com/id/1386479313/photo/happy-millennial-afro-american-business-woman-posing-isolated-on-white.webp?b=1&s=170667a&w=0&k=20&c=ahypUC_KTc95VOsBkzLFZiCQ0VJwewfrSV43BOrLETM=" alt="Image Description"/>
                            </div>
                      ...
                      <div className="space-y-5 md:space-y-8">
                          ...
                          <Image width={800} height={700}  src={post.image} alt={post.title}/>
